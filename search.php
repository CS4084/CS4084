<?php
 ...
 if (isset($_GET['q']) && !empty($_GET['q'])){
	 ...
	 $sql = "SELECT * FROM task WHERE taskTitle LIKE '%$query%' AND taskId NOT IN (SELECT taskId FROM unpublished_tasks) AND taskId NOT IN (SELECT taskId FROM task_claimed)  AND taskId NOT IN (SELECT taskId FROM task_completed) ORDER BY taskTitle ASC";
